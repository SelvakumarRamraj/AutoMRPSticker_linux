...
Public Class Frmmktbarcode
    ...
    Private Sub speedprintHbothprev()
        Dim dir As String
    ...
    Private Sub speedprint2vertbothprev()
        ...
        For i As Integer = 0 To dg.Rows.Count - 1
            ...
            If c = True Then
                ...
                If Chkshirt.Checked = True Then
                    ...
                    ' PrintLine(1, TAB(0), "BITMAP 505,133,5,32,1,ÿÿÜÿÿÇÌÿ‡ÌþÌüÌøÌð#ÌàsÈÀñÀð ø ü þ ?ÿŒÿÌÿÿÌÿÿÌÿÿïÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿ")
                    FileSystem.PrintLine(fNum2, "BITMAP 317,123,5,32,1,ÿÿÿ¿ÿþÿøÿðÿàÿÀÿ€ÿ ŽüŽøŽðŒà‡ŒÀ?€€À  ÿÀ ÿà  ÿð ÿøÿþ ?ÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿïŸÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿ")
    ...
    Private Sub speedprint2vertbothNewprevold()
        Dim dirv, mdirv As String
    ...
    Private Sub speedprint2vertbothNewprev()
        Dim dirv, mdirv As String
        ...
        For i As Integer = 0 To dg.Rows.Count - 1
            ...
            If c = True Then
                ...
                FileSystem.PrintLine(fNum2, "CLS")
                'FileSystem.PrintLine(fNum2, "BITMAP 515,161,4,24,1,ÿÿÜÿÿÇÌÿ‡ÌþÌüÌøÌð#ÌàsÈÀñÀð ø ü þ ?ÿŒÿÌÿÿÌÿÿÌÿÿïÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿ")
                FileSystem.PrintLine(fNum2, "BITMAP 505,133,5,32,1,ÿÿÿ¿ÿþÿøÿðÿàÿÀÿ€ÿ ŽüŽøŽðŒà‡ŒÀ?€€À  ÿÀ ÿà  ÿð ÿøÿþ ?ÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿïŸÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿÿ")
                FileSystem.PrintLine(fNum2, TAB(0), "CODEPAGE 1252")

                If Chkshirt.Checked = True Then
                    FileSystem.PrintLine(fNum2, TAB(0), "TEXT 543,25," & """" & "0" & """" & ",90,18,17," & """" & "MRP" & """")
                    FileSystem.PrintLine(fNum2, "TEXT 543,168," & """" & "0" & """" & ",90,18,17," & """" & Microsoft.VisualBasic.Format(Val(dg.Rows(i).Cells(12).Value), "######.00") & """")
                    FileSystem.PrintLine(fNum2, "TEXT 483,13," & """" & "0" & """" & ",90,8,11," & """" & Trim(dg.Rows(i).Cells(2).Value) & """")
                    'TEXT 538,258,"0",180,9,9,"COLOUR :9,10"
                    FileSystem.PrintLine(fNum2, "TEXT 452,13," & """" & "0" & """" & ",90,8,9," & """" & "Colour :" & """")
                    FileSystem.PrintLine(fNum2, "TEXT 420,13," & """" & "0" & """" & ",90,8,9," & """" & "Commodity :" & """")
                    FileSystem.PrintLine(fNum2, "TEXT 450,80," & """" & "ROMAN.TTF" & """" & ",90,1,8," & """" & Trim(dg.Rows(i).Cells(5).Value) & """")
                    'FileSystem.PrintLine(fNum, "TEXT 300,8," & """" & "0" & """" & ",90,7,7," & """" & "Made in India" & """")
                    FileSystem.PrintLine(fNum2, "TEXT 415,120," & """" & "0" & """" & ",90,8,8," & """" & Trim(dg.Rows(i).Cells(6).Value) & """")
                    FileSystem.PrintLine(fNum2, "TEXT 290,13," & """" & "0" & """" & ",90,7,7," & """" & "Made in India" & """")
                    FileSystem.PrintLine(fNum2, "TEXT 387,13," & """" & "ROMAN.TTF" & """" & ",90,1,10," & """" & Trim(dg.Rows(i).Cells(3).Value) & """")
                    FileSystem.PrintLine(fNum2, "TEXT 387,80," & """" & "0" & """" & ",90,9,10," & """" & "SLEEVE" & """")

                    FileSystem.PrintLine(fNum2, "TEXT 388,193," & """" & "0" & """" & ",90,11,20," & """" & "Size:" & """")
                    FileSystem.PrintLine(fNum2, "TEXT 388,260," & """" & "0" & """" & ",90,18,21," & """" & Trim(dg.Rows(i).Cells(4).Value) & """")
                    FileSystem.PrintLine(fNum2, "TEXT 390,310," & """" & "0" & """" & ",90,12,21," & """" & "cm" & """")
                    FileSystem.PrintLine(fNum2, "TEXT 320,13," & """" & "0" & """" & ",90,7,8," & """" & "Net Qty :1 N" & """")
                    FileSystem.PrintLine(fNum2, "QRCODE 326,243,L,4,A,90,M2,S7," & """" & Trim(dg.Rows(i).Cells(9).Value) & """")
                    'FileSystem.PrintLine(fNum2, "TEXT 295,122," & """" & "0" & """" & ",90,7,6," & """" & Trim(dg.Rows(i).Cells(7).Value) & """") 'mfg date
                    FileSystem.PrintLine(fNum2, "TEXT 320,212," & """" & "0" & """" & ",90,8,9," & """" & Trim(dg.Rows(i).Cells(8).Value) & """")
                    FileSystem.PrintLine(fNum2, "TEXT 320,122," & """" & "0" & """" & ",90,10,9," & """" & Trim(dg.Rows(i).Cells(1).Value) & """")
                    FileSystem.PrintLine(fNum2, "TEXT 505,115," & """" & "ROMAN.TTF" & """" & ",90,1,7," & """" & "(Incl.of all Taxes)" & """")
                    ...
                    If chkvertfit.Checked = True Then
                        ...
                        FileSystem.PrintLine(fNum2, "TEXT 260,13," & """" & "0" & """" & ",90,9,10," & """" & Trim(dg.Rows(i).Cells(16).Value) & """")
                        'cut
                        FileSystem.PrintLine(fNum2, "TEXT 350,13," & """" & "0" & """" & ",90,9,10," & """" & Trim(dg.Rows(i).Cells(17).Value) & """")
                    End If
                    If chkmfg.Checked = False Then
                        FileSystem.PrintLine(fNum2, "TEXT 110,13," & """" & "0" & """" & ",90,7,9," & """" & "* Manufacturer,Marketer & Consumer Care" & """")
                        FileSystem.PrintLine(fNum2, "TEXT 85,70," & """" & "0" & """" & ",90,8,9," & """" & "address details are available in the box" & """")
                ...
                ElseIf chkpant.Checked = True Then
                    FileSystem.PrintLine(fNum2, TAB(0), "TEXT 543,25," & """" & "0" & """" & ",90,18,17," & """" & "MRP " & """")
                    FileSystem.PrintLine(fNum2, "TEXT 543,168," & """" & "0" & """" & ",90,18,17," & """" & Microsoft.VisualBasic.Format(Val(dg.Rows(i).Cells(12).Value), "######.00") & """")
                    FileSystem.PrintLine(fNum2, "TEXT 483,13," & """" & "0" & """" & ",90,9,10," & """" & Trim(dg.Rows(i).Cells(2).Value) & """")
                    FileSystem.PrintLine(fNum2, "TEXT 450,13," & """" & "0" & """" & ",90,8,9," & """" & "Colour :" & """")
                    FileSystem.PrintLine(fNum2, "TEXT 425,13," & """" & "0" & """" & ",90,8,9," & """" & "Commodity :" & """")
                    FileSystem.PrintLine(fNum2, "TEXT 450,80," & """" & "ROMAN.TTF" & """" & ",90,1,8," & """" & Trim(dg.Rows(i).Cells(5).Value) & """")
                    FileSystem.PrintLine(fNum2, "TEXT 420,120," & """" & "0" & """" & ",90,8,8," & """" & Trim(dg.Rows(i).Cells(6).Value) & """")
                    FileSystem.PrintLine(fNum2, "TEXT 280,13," & """" & "0" & """" & ",90,7,7," & """" & "Made in India" & """")
                    FileSystem.PrintLine(fNum2, "TEXT 395,13," & """" & "ROMAN.TTF" & """" & ",90,1,11," & """" & Trim(dg.Rows(i).Cells(3).Value) & """")
                    FileSystem.PrintLine(fNum2, "TEXT 395,85," & """" & "0" & """" & ",90,8,12," & """" & "LENGTH" & """")
                    FileSystem.PrintLine(fNum2, "TEXT 360,13," & """" & "0" & """" & ",90,11,20," & """" & "Code :" & """")
                    FileSystem.PrintLine(fNum2, "TEXT 358,95," & """" & "0" & """" & ",90,18,12," & """" & Trim(dg.Rows(i).Cells(4).Value) & """")
                    FileSystem.PrintLine(fNum2, "TEXT 365,150," & """" & "0" & """" & ",90,12,21," & """" & "(Inch)" & """")
                    FileSystem.PrintLine(fNum2, "TEXT 305,13," & """" & "0" & """" & ",90,7,8," & """" & "Net Qty :1N" & """")
                    FileSystem.PrintLine(fNum2, "QRCODE 336,243,L,4,A,90,M2,S7," & """" & Trim(dg.Rows(i).Cells(9).Value) & """")
                    'FileSystem.PrintLine(fNum2, "TEXT 275,122," & """" & "0" & """" & ",90,7,6," & """" & Trim(dg.Rows(i).Cells(7).Value) & """")
                    FileSystem.PrintLine(fNum2, "TEXT 306,100," & """" & "0" & """" & ",90,8,9," & """" & Trim(dg.Rows(i).Cells(8).Value) & """")
    ...
    Private Sub speedprinthbothNewPrevold(fnum As Integer, dg As DataGridView, i As Integer)
    ...
    Private Sub speedprinthbothNewprev(fnum As Integer, dg As DataGridView, i As Integer)
        ...
        FileSystem.PrintLine(fnum, "BITMAP 283,312,4,40,1,øÿÿü ÿÿþÿÿÿÿÿÿÿÿÿ€ÿÿÿÀÿÿà?ÿÿðÿÿøÿÿüÿÿü ÿÿþÿÿÿÿÿÿ€ÿÿÿÀÿÿàÿÿà?ÿÿ€?ÿü ?ÿð ?ÿà?ÿÿÀÿÿÿÿÿÿÿÿÿ ÿÿþ ÿÿþÿÿÀ  €  ?€  ?   þÿÿÿÿÿÿ ÿÿÿ€ÿÀ  €  ?   ?ÿÿÿÿ")
        FileSystem.PrintLine(fnum, TAB(0), "CODEPAGE 1252")
        FileSystem.PrintLine(fnum, TAB(0), "TEXT 433,355," & """" & "0" & """" & ",180,20,18," & """" & "MRP" & """")

        FileSystem.PrintLine(fnum, "TEXT 277,355," & """" & "0" & """" & ",180,18,18," & """" & Microsoft.VisualBasic.Format(Val(dg.Rows(i).Cells(12).Value), "######.00") & """")
        FileSystem.PrintLine(fnum, "TEXT 538,291," & """" & "0" & """" & ",180,11,12," & """" & Trim(dg.Rows(i).Cells(2).Value) & """")
        FileSystem.PrintLine(fnum, "TEXT 538,256," & """" & "0" & """" & ",180,9,9," & """" & "COLOUR :" & """")
        FileSystem.PrintLine(fnum, "TEXT 538,228," & """" & "0" & """" & ",180,8,9," & """" & "COMMODITY :" & """")
        FileSystem.PrintLine(fnum, "TEXT 439,258," & """" & "ROMAN.TTF" & """" & ",180,1,9," & """" & Trim(dg.Rows(i).Cells(5).Value) & """")

        FileSystem.PrintLine(fnum, "TEXT 410,228," & """" & "0" & """" & ",180,9,9," & """" & Trim(dg.Rows(i).Cells(6).Value) & """")
        FileSystem.PrintLine(fnum, "TEXT 367,189," & """" & "0" & """" & ",180,10,8," & """" & "Made in India" & """")
        ...
        FileSystem.PrintLine(fnum, "QRCODE 519,202,L,4,A,180,M2,S7," & """" & Trim(dg.Rows(i).Cells(9).Value) & """")
        'FileSystem.PrintLine(fnum, "TEXT 367,159," & """" & "0" & """" & ",180,10,8," & """" & Trim(dg.Rows(i).Cells(7).Value) & """") 'mfg date
        FileSystem.PrintLine(fnum, "TEXT 267,131," & """" & "0" & """" & ",180,10,9," & """" & Trim(dg.Rows(i).Cells(8).Value) & """")
        FileSystem.PrintLine(fnum, "TEXT 352,131," & """" & "0" & """" & ",180,9,8," & """" & Trim(dg.Rows(i).Cells(1).Value) & """")
        FileSystem.PrintLine(fnum, "TEXT 346,313," & """" & "ROMAN.TTF" & """" & ",180,1,7," & """" & "(Incl.of all Taxes)" & """")
